namespace Fizzler
{
    ...
    : IEquatable<Token>
    {
...
#if SALTARELLE
        public Token Value { get { return this; } }
#endif
        ...
        {
            return Text == null ? ToString(Kind) : ToString(Kind) + ": " + Text;
        }
        /// <summary>
        ...
        {
#if SALTARELLE
            // Structs are not available in Saltarelle, perform extra checks
            if (Script.IsNull(a) && Script.IsNull(b)) return true;
            if (Script.IsNull(a) || Script.IsNull(b)) return false;
#endif
            return a.Equals(b);
        }
